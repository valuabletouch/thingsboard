...
@Configuration
@EnableMongoRepositories(basePackages = { "org.thingsboard.server.dao.vsensor.mongo.repository.readingtype" }, mongoTemplateRef = ReadingTypeConfig.MONGO_TEMPLATE)
