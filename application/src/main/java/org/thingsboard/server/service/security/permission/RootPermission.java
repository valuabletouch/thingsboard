...
@Component(value="rootPermissions")
public class RootPermission extends AbstractPermissions {
    ...
    public RootPermission() {
        ...
        put(Resource.DEVICE_PROFILE, PermissionChecker.allowAllPermissionChecker);
        put(Resource.API_USAGE_STATE, PermissionChecker.allowAllPermissionChecker);
    }
}
